...
- [docs/global/PAYMENTS-LEDGER.md](../docs/global/PAYMENTS-LEDGER.md) — payments ledger model, `PaymentObserver` (sole writer of paid caches), `PAY-`/`INV-`/`RCP-` numbering, build phases
