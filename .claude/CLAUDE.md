...
- [docs/global/MCP-CONNECTOR.md](../docs/global/MCP-CONNECTOR.md) — the scoped `/v1/connector/*` API + Cloudflare Worker MCP server (`connector/`) that lets Claude draft quotations; draft-only Sanctum abilities, token minting, Worker deploy
