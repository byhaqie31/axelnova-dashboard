...
import FeaturedProjectCard from '~/components/shared/FeaturedProjectCard.vue'
...
<template>
  <div class="relative">
    ...
    <div
      ...
      tabindex="0"
      class="fcarousel flex items-stretch gap-6 overflow-x-auto snap-x snap-mandatory pb-3"
...
.fnav--prev { left: 0.5rem; }
.fnav--next { right: 0.5rem; }

@media (min-width: 640px) {
  .fnav { display: inline-flex; }
}

.fnav:hover:not(:disabled) {
