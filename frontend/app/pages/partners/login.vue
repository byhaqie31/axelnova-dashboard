...
const redirectTo = computed(() => {
  ...
  return typeof r === 'string' && r.startsWith('/partners') && !r.startsWith('//') ? r : '/partners/home'
})

// The auth interceptor sets ?expired=1 when it bounces the partner here after the API
