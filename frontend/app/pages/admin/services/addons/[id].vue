...
<template>
  <div class="max-w-2xl mx-auto px-4 sm:px-6 pt-10 pb-32">
    <NuxtLink to="/admin/services/addons" class="inline-flex items-center gap-2 text-[13px] mb-8 transition-opacity hover:opacity-70"
    ...
    <form v-if="!loading" class="rounded-2xl border p-6 space-y-5"
      ...
      <div class="grid sm:grid-cols-2 gap-4">
        <div>
          ...
          <input v-model="form.addon_key" type="text" required placeholder="e.g. seo"
        ...
        <div>
          ...
          <input v-model="form.label" type="text" required placeholder="e.g. SEO setup"
      ...
      <div>
        ...
        <input v-model.number="form.amount_myr" type="number" min="0" step="50" required
          class="contact-input w-full"
          :style="{ borderColor: 'var(--color-border)', color: 'var(--color-text)', background: 'var(--color-bg)' }" />
