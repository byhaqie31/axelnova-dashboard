...
async function fetchInquiries() {
  ...
  try {
    ...
    const res = await apiFetch<{ data: Inquiry[]; meta: any }>(`/api/v1/team/inquiries?${params}`)
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 pt-10 pb-32">
    ...
    <div class="flex items-center justify-between mb-8 flex-wrap gap-4">
      <div>
        ...
        <p class="text-[14px] mt-1" style="color: var(--color-text-secondary);">Project inquiries from the public site. Open one to triage and respond.</p>
      </div>
    </div>
